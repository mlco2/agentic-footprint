...
Please describe the commands, platforms, and scenarios used to test the change.

## Measurement, Privacy, and Compatibility
Describe any changes to event contracts, attribution, uncertainty, collected
data, local persistence, agent configuration, or supported platforms.
